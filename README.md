...
In order to get a fully rigorous proof, you need the Intlab toolbox (http://www.ti3.tu-harburg.de/intlab/). The code still runs without it, but then rouding errors are not controlled.
